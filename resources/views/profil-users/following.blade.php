...
<div class="m-auto" style="width: 84%">
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2 row mt-5 d-flex flex-wrap">
                    ...
                    <div class="bg-white border  mt-2 col-4 ml-2" style="height: 150px;  background: url('/img/{{ $following->avatar }}') no-repeat;  background-size: cover;  border-radius: 22px #665A5C;box-shadow: 4px 2px 4px #665A5C;">
                   <div class="row">
